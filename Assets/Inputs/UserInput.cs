...
public partial class @UserInput : IInputActionCollection2, IDisposable
{
    ...
    public struct DesktopActions
    {
        ...
        public void SetCallbacks(IDesktopActions instance)
        {
            ...
            {
                @MouseDelta.started -= m_Wrapper.m_DesktopActionsCallbackInterface.OnMouseDelta;
                @MouseDelta.performed -= m_Wrapper.m_DesktopActionsCallbackInterface.OnMouseDelta;
                @MouseDelta.canceled -= m_Wrapper.m_DesktopActionsCallbackInterface.OnMouseDelta;
                ...
                @MouseScroll.started -= m_Wrapper.m_DesktopActionsCallbackInterface.OnMouseScroll;
                @MouseScroll.performed -= m_Wrapper.m_DesktopActionsCallbackInterface.OnMouseScroll;
                @MouseScroll.canceled -= m_Wrapper.m_DesktopActionsCallbackInterface.OnMouseScroll;
                @LeftClick.started -= m_Wrapper.m_DesktopActionsCallbackInterface.OnLeftClick;
                @LeftClick.performed -= m_Wrapper.m_DesktopActionsCallbackInterface.OnLeftClick;
                @LeftClick.canceled -= m_Wrapper.m_DesktopActionsCallbackInterface.OnLeftClick;
                @RightClick.started -= m_Wrapper.m_DesktopActionsCallbackInterface.OnRightClick;
                @RightClick.performed -= m_Wrapper.m_DesktopActionsCallbackInterface.OnRightClick;
                @RightClick.canceled -= m_Wrapper.m_DesktopActionsCallbackInterface.OnRightClick;
                @Quit.started -= m_Wrapper.m_DesktopActionsCallbackInterface.OnQuit;
                @Quit.performed -= m_Wrapper.m_DesktopActionsCallbackInterface.OnQuit;
                @Quit.canceled -= m_Wrapper.m_DesktopActionsCallbackInterface.OnQuit;
            }
    ...
    private IIOSActions m_IOSActionsCallbackInterface;
    ...
    public struct IOSActions
    {
        ...
        {
            if (m_Wrapper.m_IOSActionsCallbackInterface != null)
            {
                @Primary.started -= m_Wrapper.m_IOSActionsCallbackInterface.OnPrimary;
                @Primary.performed -= m_Wrapper.m_IOSActionsCallbackInterface.OnPrimary;
                @Primary.canceled -= m_Wrapper.m_IOSActionsCallbackInterface.OnPrimary;
                @Secondary.started -= m_Wrapper.m_IOSActionsCallbackInterface.OnSecondary;
                @Secondary.performed -= m_Wrapper.m_IOSActionsCallbackInterface.OnSecondary;
                @Secondary.canceled -= m_Wrapper.m_IOSActionsCallbackInterface.OnSecondary;
            }
            m_Wrapper.m_IOSActionsCallbackInterface = instance;
            if (instance != null)
            {
